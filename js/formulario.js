...
var formulario = document.login_user,
...
var validarRadios = function(){
	var opciones = document.getElementsByName('rol'),
		resultado = false;

	for (var i = 0; i < elementos.length; i++) {
		if(elementos[i].type == "radio" && elementos[i].name == "rol"){
...
var validarCheckbox = function(){
	var opciones = document.getElementsByName('remember'),
		resultado = false;
