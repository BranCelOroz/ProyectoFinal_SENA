...
$sel = $conexion -> query("SELECT * FROM clientes WHERE id='$id==3'");
...
<form  class="formreg" action="updatec.php" method="post">
	<input type="hidden" name="id" value="<?php echo $id?>">
         ...
         <input  name="genero" id="input" type="text" required class="form-control" disabled="" value="<?php echo $fila['genero'] ?>">
          <input  name="tid" id="input" type="text" required class="form-control"   value="<?php echo $fila['tidentificacion'] ?>" >
